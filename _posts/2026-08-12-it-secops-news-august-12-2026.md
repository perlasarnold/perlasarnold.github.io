...
- 📆 **[Microsoft Copilot (Microsoft 365): Add Agents and Skills from the Plus menu](https://www.microsoft.com/microsoft-365/roadmap?id=569213)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569213)
  Users will be able to insert Agents and Skills in prompts for specialized tasks. They can add them from the Agents and Skills tab after selecting 'Add work content' from the plus (+) menu. Users can also access Agents and Skills by typing / and @ in their prompt. GA date: Sept...

- 📆 **[Microsoft Copilot (Microsoft 365):  JPG and PNG references in Copilot Notebooks](https://www.microsoft.com/microsoft-365/roadmap?id=569211)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569211)
  Copilot Notebooks now supports JPG and PNG files as knowledge sources, allowing users to bring images directly into their projects alongside traditional documents. Copilot can use the content within these images, including text, charts, diagrams, and other visuals, as groundin...

- 📆 **[Microsoft Copilot (Microsoft 365): CSV and TSV references in Copilot Notebooks](https://www.microsoft.com/microsoft-365/roadmap?id=569210)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569210)
  Copilot Notebooks now supports CSV and TSV files as knowledge sources, allowing users to bring structured lists and tables directly into their projects alongside traditional documents. This additional context helps Copilot generate more relevant presentations, reports, and bri...

- 📆 **[Microsoft Teams: Add multiple steps when building a workflow from scratch](https://www.microsoft.com/microsoft-365/roadmap?id=569209)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569209)
  You will now be able to add multiple steps to your workflow when building one from scratch. GA date: September CY2026

- 📆 **[SharePoint: HTML pages](https://www.microsoft.com/microsoft-365/roadmap?id=569208)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569208)
  Create HTML with Copilot in SharePoint or upload your own HTML from another source. Once stored in the pages library, you can render HTML as a page in SharePoint, make additional edits, and share with your audience. HTML gives you new ways to present your content beautifully a...

- 📆 **[OneNote: New Copilot Notebooks design in the Microsoft 365 Copilot app (DoD, GCC, GCC High)](https://www.microsoft.com/microsoft-365/roadmap?id=569203)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569203)
  The new Copilot Notebooks design in the Microsoft 365 Copilot app for DoD, GCC, and GCC High clouds now lets users organize related chats, output creations, and references into a persistent AI workspace. Copilot uses the Notebook's accumulated context to ground responses, so w...

- 📆 **[Microsoft Teams: Identify custom apps that need updates for Teams private and shared channels](https://www.microsoft.com/microsoft-365/roadmap?id=569019)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=569019)
  Admins will be able to view in Teams Admin Center a list of custom apps in their tenant that need to be updated to work in private and shared channels. This experience will help admins identify impacted apps, understand which apps require developer action, and coordinate updat...

- 📆 **[Microsoft Teams: Collect information with list form in Workflows](https://www.microsoft.com/microsoft-365/roadmap?id=568932)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=568932)
  Starts a workflow with a form to collect the information you need to run the rest of your workflow. GA date: September CY2026

- 📆 **[Microsoft Entra: Windows Hello for Business and macOS Platform Single Sign-on can now be used as a second factor for MFA](https://www.microsoft.com/microsoft-365/roadmap?id=568076)** — *Microsoft 365 Roadmap* · [Read Announcement →](https://www.microsoft.com/microsoft-365/roadmap?id=568076)
  Windows Hello for Business (WHfB) and macOS Platform SSO (macOS PSSO) can now satisfy multifactor authentication as a standalone second factor. Previously, these methods only counted as MFA during primary sign-in, and users needed a separate passkey to complete step-up prompts...
...
- **[Microsoft: Windows 10 KB5120249 August 2026 Patch Tuesday update now available](https://www.neowin.net/news/microsoft-windows-10-kb5120249-august-2026-patch-tuesday-update-now-available/?utm_source=rss)** — *Neowin* · [Read Article →](https://www.neowin.net/news/microsoft-windows-10-kb5120249-august-2026-patch-tuesday-update-now-available/?utm_source=rss) — 🔧 **KB:** [KB5120249 (Microsoft Support)](https://support.microsoft.com/help/5120249)
  Microsoft has released the August 2026 Patch Tuesday cumulative updates for Windows 10 under [KB5120249](https://support.microsoft.com/help/5120249). Read more...

- **[Windows 11 KB5121003, KB5120240, and KB5121000 Patch Tuesday updates are now available](https://www.neowin.net/news/windows-11-kb5121003-kb5120240-and-kb5121000-patch-tuesday-updates-are-now-available/?utm_source=rss)** — *Neowin* · [Read Article →](https://www.neowin.net/news/windows-11-kb5121003-kb5120240-and-kb5121000-patch-tuesday-updates-are-now-available/?utm_source=rss) — 🔧 **KB:** [KB5121003 (Microsoft Support)](https://support.microsoft.com/help/5121003) · 🔧 **KB:** [KB5120240 (Microsoft Support)](https://support.microsoft.com/help/5120240) · 🔧 **KB:** [KB5121000 (Microsoft Support)](https://support.microsoft.com/help/5121000)
  Microsoft has released Patch Tuesday updates [KB5121003](https://support.microsoft.com/help/5121003), [KB5120240](https://support.microsoft.com/help/5120240), and [KB5121000](https://support.microsoft.com/help/5121000) for Windows 11 for August 2026. Here's what's included: Read more...
...
- **[Microsoft releases Windows 10 KB5120249 extended security update](https://www.bleepingcomputer.com/news/microsoft/windows-10-kb5120249-cumulative-update-released-with-fixes/)** — *BleepingComputer* · [View Thread →](https://www.bleepingcomputer.com/news/microsoft/windows-10-kb5120249-cumulative-update-released-with-fixes/) — 🔧 **KB:** [KB5120249 (Microsoft Support)](https://support.microsoft.com/help/5120249)
  > Microsoft has released Windows 10 [KB5120249](https://support.microsoft.com/help/5120249) Extended Security Updates for versions 22H2 and 21H2 to fix security vulnerabilities and bugs. [...]

- **[Windows 11 KB5121003 & KB5120240 cumulative updates released](https://www.bleepingcomputer.com/news/microsoft/windows-11-kb5121003-and-kb5120240-cumulative-updates-released/)** — *BleepingComputer* · [View Thread →](https://www.bleepingcomputer.com/news/microsoft/windows-11-kb5121003-and-kb5120240-cumulative-updates-released/) — 🔧 **KB:** [KB5121003 (Microsoft Support)](https://support.microsoft.com/help/5121003) · 🔧 **KB:** [KB5120240 (Microsoft Support)](https://support.microsoft.com/help/5120240)
  > Microsoft has released Windows 11 [KB5121003](https://support.microsoft.com/help/5121003) and [KB5120240](https://support.microsoft.com/help/5120240) cumulative updates for versions 25H2/24H2 and 23H2 to fix security vulnerabilities, bugs, and add new features. [...]

- **[Wesco confirms security incident after ExfilSquad claims data theft](https://www.bleepingcomputer.com/news/security/wesco-confirms-security-incident-after-exfilsquad-claims-data-theft/)** — *BleepingComputer* · [View Thread →](https://www.bleepingcomputer.com/news/security/wesco-confirms-security-incident-after-exfilsquad-claims-data-theft/)
